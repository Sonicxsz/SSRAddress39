  ...
  return (
    ...
    <div className={styles.contactsWrapper} ref={refs}>
      ...
      <div className={styles.contactsConnection}>
        ...
        <a className={styles.contactsWhats} href="https://wa.me/+79850390039">
          WhatsApp: + 7(985)039-00-39
        </a>
        <a className={styles.contactsMail} href="mailto:addrest.39@mail.ru">
          addrest.39@mail.ru
        </a>
      </div>
      <div className={styles.timeWork}>
        {langData.worktime}
        <div className={styles.timeWorkText}>{langData.days} 11:00 - 00:00</div>
      </div>
