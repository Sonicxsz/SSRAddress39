...
const DeliveryPage: NextPage<deleveryProps> = ({ data }: deleveryProps) => {
    ...
    return (
        <>
            <Head>
                <title>
                    Доставка или Самовывоз в ресторане Адрес39 в Москве
                </title>
                <meta
                    name="description"
                    content="Адрес39 – Доставка и самовывоз в ресторане Адрес39 - разные блюда от шеф повара высшей категории"
                />
            ...
            <div className={styles.pageWrapper}>
                ...
                {data.map((i, ind) => {
                    ...
                    return (
                        <div className={styles.categoryBlock} key={ind}>
