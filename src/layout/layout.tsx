    ...
    return (
        <div className={styles.app}>
            <div className={styles.main}>
                <Navigation
                    openModalDelevery={() =>
                        openModal(dispatch, setModalDelevery)
                    }
                    openModalCarrer={() => openModal(dispatch, setModalCarreer)}
                    openModalBooking={() =>
                        openModal(dispatch, setModalBooking)
                    }
                    moveToContact={moveToContact}
                />
                <Modal
                    label={modalLang.vacancy}
                    showModal={modalCarreer}
                    closeModal={() => closeModal(dispatch, setModalCarreer)}
                    type="career"
                />
                <Modal
                    label={modalLang.booking}
                    showModal={modalBooking}
                    closeModal={() => closeModal(dispatch, setModalBooking)}
                    type="booking"
                />
                <Modal
                ...
                <MenuModal
                    ...
                    closeModal={() =>
                        dispatch(setMenuModal({ visible: false, type: '' }))
                    }
                />
                {children}
                <Cookie />
